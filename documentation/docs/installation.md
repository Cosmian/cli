=== "Ubuntu 22.04"
    ...
    wget https://package.cosmian.com/cli/1.0.0/ubuntu-22.04/cosmian-cli_1.0.0-1_amd64.deb
...
=== "Rocky Linux 8"
    ...
    wget https://package.cosmian.com/cli/1.0.0/rockylinux8/cosmian_cli-1.0.0-1.x86_64.rpm
    sudo dnf install ./cosmian_cli-1.0.0-1.x86_64.rpm
    cosmian --version
    ```
...
=== "Rocky Linux 9"
    ...
    ```console title="On local machine"
    sudo dnf update && sudo dnf install -y wget
    wget https://package.cosmian.com/cli/1.0.0/rockylinux9/cosmian_cli-1.0.0-1.x86_64.rpm
    sudo dnf install ./cosmian_cli-1.0.0-1.x86_64.rpm
    cosmian --version
    ```
...
=== "MacOS"
    ...
    ```console title="On local machine"
    wget https://package.cosmian.com/cli/1.0.0/macos_arm-release.zip
    ...
    ```console title="On local machine"
    wget https://package.cosmian.com/cli/1.0.0/macos_intel-release.zip
...
=== "Windows"
    ...
    ```console title="Build archive"
     https://package.cosmian.com/cli/1.0.0/windows-release.zip
    ```
