...
**`hash`** [[1.10]](#110-cosmian-kms-hash)  Hash arbitrary data.

**`mac`** [[1.11]](#111-cosmian-kms-mac)  Hash arbitrary data with a MAC key.
...
**`decrypt`** [[1.12.3]](#1123-cosmian-kms-rsa-decrypt)  Decrypt a file with the given private key using either
