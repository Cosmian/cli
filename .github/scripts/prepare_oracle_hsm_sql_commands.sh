...
display_wallet() {
  ...
  run_sql "SELECT * FROM V\$ENCRYPTION_KEYS;"
}
...
# run_sql "ADMINISTER KEY MANAGEMENT CREATE KEYSTORE IDENTIFIED BY hsm_identity_pass;" # password-based keystore does not work on HSM
...
# TMP commands
# run_sql "ALTER SYSTEM SET PKCS11_LIBRARY_LOCATION='/opt/oracle/extapi/64/hsm/Cosmian/libcosmian_pkcs11.so';"
